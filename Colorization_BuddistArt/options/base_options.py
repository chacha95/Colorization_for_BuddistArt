...
class BaseOptions():
    ...
    def initialize(self):
        self.parser.add_argument('--dataroot', default='./datasets/colorize', help='path to images (should have subfolders trainA, trainB, valA, valB, etc)')
        ...
        self.parser.add_argument('--name', type=str, default='colorize', help='name of the experiment. It decides where to store samples and models')
        ...
        self.parser.add_argument('--serial_batches', action='store_true', help='if c  true, takes images in order to make batches, otherwise takes them randomly')
        self.parser.add_argument('--display_winsize', type=int, default=256, help='display window size')
        self.parser.add_argument('--display_id', type=int, default=1, help='window id of the web display')
        self.parser.add_argument('--display_port', type=int, default=5724, help='visdom port of the web display')
